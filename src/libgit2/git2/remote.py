...
from .transport  import git_transport_message_cb
from .pack       import git_packbuilder_progress
...
#
git_remote_create = CFUNC(ct.c_int,
    ct.POINTER(ct.POINTER(git_remote)),
    ct.POINTER(git_repository),
    ct.c_char_p,
    ct.c_char_p)(
    ("git_remote_create", dll), (
    (1, "out"),
    (1, "repo"),
    (1, "name"),
    (1, "url"),))
...
#
git_remote_redirect_t = ct.c_int
(
...
#
git_remote_create_flags = ct.c_int
(
...
#
#
class git_remote_create_options(ct.Structure):
    _fields_ = [
    ("version", ct.c_uint),
    ...
    #
    ("repository", ct.POINTER(git_repository)),
...
#
git_remote_create_options_init = CFUNC(ct.c_int,
    ct.POINTER(git_remote_create_options),
    ct.c_uint)(
    ("git_remote_create_options_init", dll), (
    (1, "opts"),
    (1, "version"),))
...
# @return 0, GIT_EINVALIDSPEC, GIT_EEXISTS or an error code
#
git_remote_create_with_opts = CFUNC(ct.c_int,
    ct.POINTER(ct.POINTER(git_remote)),
    ct.c_char_p,
    ct.POINTER(git_remote_create_options))(
    ("git_remote_create_with_opts", dll), (
    (1, "out"),
    (1, "url"),
    (1, "opts"),))
...
# @return 0, GIT_EINVALIDSPEC, GIT_EEXISTS or an error code
#
git_remote_create_with_fetchspec = CFUNC(ct.c_int,
    ct.POINTER(ct.POINTER(git_remote)),
    ct.POINTER(git_repository),
    ct.c_char_p,
    ct.c_char_p,
    ct.c_char_p)(
    ("git_remote_create_with_fetchspec", dll), (
    (1, "out"),
    (1, "repo"),
    (1, "name"),
    (1, "url"),
...
#
git_remote_create_anonymous = CFUNC(ct.c_int,
    ct.POINTER(ct.POINTER(git_remote)),
    ct.POINTER(git_repository),
    ct.c_char_p)(
    ("git_remote_create_anonymous", dll), (
    (1, "out"),
    (1, "repo"),
    (1, "url"),))
...
# @return 0 or an error code
#
git_remote_create_detached = CFUNC(ct.c_int,
    ct.POINTER(ct.POINTER(git_remote)),
    ct.c_char_p)(
    ("git_remote_create_detached", dll), (
    (1, "out"),
    (1, "url"),))
...
#
git_remote_lookup = CFUNC(ct.c_int,
    ct.POINTER(ct.POINTER(git_remote)),
    ct.POINTER(git_repository),
    ct.c_char_p)(
    ("git_remote_lookup", dll), (
    (1, "out"),
    (1, "repo"),
    (1, "name"),))
...
#
git_remote_owner = CFUNC(ct.POINTER(git_repository),
    ct.POINTER(git_remote))(
    ("git_remote_owner", dll), (
    (1, "remote"),))
...
#
git_remote_name = CFUNC(ct.c_char_p,
    ct.POINTER(git_remote))(
    ("git_remote_name", dll), (
    (1, "remote"),))
...
#
git_remote_url = CFUNC(ct.c_char_p,
    ct.POINTER(git_remote))(
    ("git_remote_url", dll), (
    (1, "remote"),))
...
#
git_remote_pushurl = CFUNC(ct.c_char_p,
    ct.POINTER(git_remote))(
    ("git_remote_pushurl", dll), (
    (1, "remote"),))
...
#
git_remote_set_url = CFUNC(ct.c_int,
    ct.POINTER(git_repository),
    ct.c_char_p,
    ct.c_char_p)(
    ("git_remote_set_url", dll), (
    (1, "repo"),
    (1, "remote"),
    (1, "url"),))
...
# @return 0, or an error code
#
git_remote_set_pushurl = CFUNC(ct.c_int,
    ct.POINTER(git_repository),
    ct.c_char_p,
    ct.c_char_p)(
    ("git_remote_set_pushurl", dll), (
    (1, "repo"),
    (1, "remote"),
    (1, "url"),))
...
# @return 0 or an error value
#
git_remote_set_instance_url = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    ct.c_char_p)(
    ("git_remote_set_instance_url", dll), (
    (1, "remote"),
    (1, "url"),))
...
# @return 0 or an error value
#
git_remote_set_instance_pushurl = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    ct.c_char_p)(
    ("git_remote_set_instance_pushurl", dll), (
    (1, "remote"),
    (1, "url"),))
...
#
git_remote_add_fetch = CFUNC(ct.c_int,
    ct.POINTER(git_repository),
    ct.c_char_p,
    ct.c_char_p)(
    ("git_remote_add_fetch", dll), (
    (1, "repo"),
    (1, "remote"),
    (1, "refspec"),))
...
# @return 0 or an error code.
#
git_remote_get_fetch_refspecs = CFUNC(ct.c_int,
    ct.POINTER(git_strarray),
    ct.POINTER(git_remote))(
    ("git_remote_get_fetch_refspecs", dll), (
    (1, "array"),
    (1, "remote"),))
...
# @return 0, GIT_EINVALIDSPEC if refspec is invalid or an error value
#
git_remote_add_push = CFUNC(ct.c_int,
    ct.POINTER(git_repository),
    ct.c_char_p,
    ct.c_char_p)(
    ("git_remote_add_push", dll), (
    (1, "repo"),
    (1, "remote"),
    (1, "refspec"),))
...
# @return 0 or an error code.
#
git_remote_get_push_refspecs = CFUNC(ct.c_int,
    ct.POINTER(git_strarray),
    ct.POINTER(git_remote))(
    ("git_remote_get_push_refspecs", dll), (
    (1, "array"),
    (1, "remote"),))
...
#
git_remote_refspec_count = CFUNC(ct.c_size_t,
    ct.POINTER(git_remote))(
    ("git_remote_refspec_count", dll), (
    (1, "remote"),))
...
#
git_remote_get_refspec = CFUNC(ct.POINTER(git_refspec),
    ct.POINTER(git_remote),
    ct.c_size_t)(
    ("git_remote_get_refspec", dll), (
    (1, "remote"),
    (1, "n"),))
...
#
git_remote_ls = CFUNC(ct.c_int,
    ct.POINTER(ct.POINTER(ct.POINTER(git_remote_head))),
...
#
git_remote_connected = CFUNC(ct.c_int,
    ct.POINTER(git_remote))(
    ("git_remote_connected", dll), (
    (1, "remote"),))
...
# @return 0 on success, or an error code
#
git_remote_stop = CFUNC(ct.c_int,
    ct.POINTER(git_remote))(
    ("git_remote_stop", dll), (
    (1, "remote"),))
...
# @return 0 on success, or an error code
#
git_remote_disconnect = CFUNC(ct.c_int,
    ct.POINTER(git_remote))(
    ("git_remote_disconnect", dll), (
    (1, "remote"),))
...
# @return 0 or an error code
#
git_remote_list = CFUNC(ct.c_int,
    ct.POINTER(git_strarray),
    ct.POINTER(git_repository))(
    ("git_remote_list", dll), (
    (1, "out"),
...
# finished.
#
git_remote_completion_t = ct.c_int
...
git_push_transfer_progress_cb = GIT_CALLBACK(ct.c_int,
    ct.c_uint,    # current
    ct.c_uint,    # total
    ct.c_size_t,  # bytes
    ct.c_void_p)  # payload
...
#
class git_push_update(ct.Structure):
    _fields_ = [
    # The source name of the reference
    #
    ("src_refname", ct.c_char_p),

    # The name of the reference to update on the server
    #
    ("dst_refname", ct.c_char_p),
...
#
git_push_negotiation = GIT_CALLBACK(ct.c_int,
    ct.POINTER(ct.POINTER(git_push_update)),  # updates
    ct.c_size_t,                              # len
    ct.c_void_p)                              # payload
...
#
git_push_update_reference_cb = GIT_CALLBACK(ct.c_int,
    ct.c_char_p,  # refname
    ct.c_char_p,  # status
    ct.c_void_p)  # data
...
if not defined("GIT_DEPRECATE_HARD"):
    ...
    #
    git_url_resolve_cb = GIT_CALLBACK(ct.c_int,
        ct.POINTER(git_buf),  # url_resolved
        ct.c_char_p,          # url
        ct.c_int,             # direction
        ct.c_void_p)          # payload
# endif
...
#
git_remote_ready_cb = GIT_CALLBACK(ct.c_int,
    ct.POINTER(git_remote),  # remote
    ct.c_int,                # direction
    ct.c_void_p)             # payload
...
#
class git_remote_callbacks(ct.Structure):
    _fields_ = [
    ...
    #
    ("completion", GIT_CALLBACK(ct.c_int,
    ...
    #
    ("update_tips", GIT_CALLBACK(ct.c_int,
                        ct.c_char_p,          # refname
                        ct.POINTER(git_oid),  # a
                        ct.POINTER(git_oid),  # b
                        ct.c_void_p)),        # data
...
# @return Zero on success; -1 on failure.
#
git_remote_init_callbacks = CFUNC(ct.c_int,
    ct.POINTER(git_remote_callbacks),
    ct.c_uint)(
    ("git_remote_init_callbacks", dll), (
    (1, "opts"),
    (1, "version"),))

# Acceptable prune settings when fetching
git_fetch_prune_t = ct.c_int
(
...
#
git_remote_autotag_option_t = ct.c_int
(
    # Use the setting from the configuration.
    #
...
#
class git_fetch_options(ct.Structure):
    _fields_ = [
    ("version", ct.c_int),
...
#GIT_FETCH_OPTIONS_INIT = { GIT_FETCH_OPTIONS_VERSION,
...
# @return Zero on success; -1 on failure.
#
git_fetch_options_init = CFUNC(ct.c_int,
    ct.POINTER(git_fetch_options),
    ct.c_uint)(
    ("git_fetch_options_init", dll), (
    (1, "opts"),
    (1, "version"),))

# Controls the behavior of a git_push object.
#
class git_push_options(ct.Structure):
    _fields_ = [
    ("version", ct.c_uint),
...
#GIT_PUSH_OPTIONS_INIT = { GIT_PUSH_OPTIONS_VERSION, 1,
#                          GIT_REMOTE_CALLBACKS_INIT,
#                          GIT_PROXY_OPTIONS_INIT }
...
# @return Zero on success; -1 on failure.
#
git_push_options_init = CFUNC(ct.c_int,
    ct.POINTER(git_push_options),
    ct.c_uint)(
    ("git_push_options_init", dll), (
    (1, "opts"),
    (1, "version"),))
...
#
#
class git_remote_connect_options(ct.Structure):
    _fields_ = [
    ("version", ct.c_uint),
...
#GIT_REMOTE_CONNECT_OPTIONS_INIT = { GIT_REMOTE_CONNECT_OPTIONS_VERSION,
#                                    GIT_REMOTE_CALLBACKS_INIT,
#                                    GIT_PROXY_OPTIONS_INIT }
...
# @return Zero on success; -1 on failure.
#
git_remote_connect_options_init = CFUNC(ct.c_int,
    ct.POINTER(git_remote_connect_options),
    ct.c_uint)(
    ("git_remote_connect_options_init", dll), (
    (1, "opts"),
    (1, "version"),))
...
# @return 0 or an error code
#
git_remote_connect = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    git_direction,
    ct.POINTER(git_remote_callbacks),
    ct.POINTER(git_proxy_options),
    ct.POINTER(git_strarray))(
    ("git_remote_connect", dll), (
    (1, "remote"),
    (1, "direction"),
    (1, "callbacks"),
    (1, "proxy_opts"),
...
# @return 0 or an error code
#
git_remote_connect_ext = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    git_direction,
    ct.POINTER(git_remote_connect_options))(
    ("git_remote_connect_ext", dll), (
    (1, "remote"),
    (1, "direction"),
    (1, "opts"),))
...
# @return 0 or an error code
#
git_remote_download = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    ct.POINTER(git_strarray),
    ct.POINTER(git_fetch_options))(
    ("git_remote_download", dll), (
    (1, "remote"),
    (1, "refspecs"),
    (1, "opts"),))
...
# @return 0 or an error code
#
git_remote_upload = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    ct.POINTER(git_strarray),
    ct.POINTER(git_push_options))(
    ("git_remote_upload", dll), (
    (1, "remote"),
    (1, "refspecs"),
    (1, "opts"),))
...
# @return 0 or an error code
#
git_remote_update_tips = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    ct.POINTER(git_remote_callbacks),
    ct.c_int,
    git_remote_autotag_option_t,
    ct.c_char_p)(
    ("git_remote_update_tips", dll), (
    (1, "remote"),
    (1, "callbacks"),
    (1, "update_fetchhead"),
    (1, "download_tags"),
...
# @return 0 or an error code
#
git_remote_fetch = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    ct.POINTER(git_strarray),
    ct.POINTER(git_fetch_options),
    ct.c_char_p)(
    ("git_remote_fetch", dll), (
    (1, "remote"),
    (1, "refspecs"),
    (1, "opts"),
    (1, "reflog_message"),))
...
# @return 0 or an error code
#
git_remote_prune = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    ct.POINTER(git_remote_callbacks))(
    ("git_remote_prune", dll), (
    (1, "remote"),
    (1, "callbacks"),))
...
# @return 0 or an error code.
#
git_remote_push = CFUNC(ct.c_int,
    ct.POINTER(git_remote),
    ct.POINTER(git_strarray),
    ct.POINTER(git_push_options))(
    ("git_remote_push", dll), (
...
#
git_remote_stats = CFUNC(ct.POINTER(git_indexer_progress),
    ct.POINTER(git_remote))(
    ("git_remote_stats", dll), (
    (1, "remote"),))
...
#
git_remote_autotag = CFUNC(git_remote_autotag_option_t,
    ct.POINTER(git_remote))(
    ("git_remote_autotag", dll), (
    (1, "remote"),))
...
# @return 0, or an error code.
#
git_remote_set_autotag = CFUNC(ct.c_int,
    ct.POINTER(git_repository),
    ct.c_char_p,
    git_remote_autotag_option_t)(
    ("git_remote_set_autotag", dll), (
    (1, "repo"),
    (1, "remote"),
    (1, "value"),))
...
#
git_remote_prune_refs = CFUNC(ct.c_int,
    ct.POINTER(git_remote))(
    ("git_remote_prune_refs", dll), (
    (1, "remote"),))
...
# @return 0, GIT_EINVALIDSPEC, GIT_EEXISTS or an error code
#
git_remote_rename = CFUNC(ct.c_int,
    ct.POINTER(git_strarray),
    ct.POINTER(git_repository),
    ct.c_char_p,
    ct.c_char_p)(
    ("git_remote_rename", dll), (
    (1, "problems"),
    (1, "repo"),
    (1, "name"),
    (1, "new_name"),))
...
# @return 0 on success or an error code
#
git_remote_name_is_valid = CFUNC(ct.c_int,
    ct.POINTER(ct.c_int),
    ct.c_char_p)(
    ("git_remote_name_is_valid", dll), (
    (1, "valid      "),
    (1, "remote_name"),))
...
# @return 0 on success, or an error code.
#
git_remote_delete = CFUNC(ct.c_int,
    ct.POINTER(git_repository),
    ct.c_char_p)(
    ("git_remote_delete", dll), (
    (1, "repo"),
    (1, "name"),))
...
#
git_remote_default_branch = CFUNC(ct.c_int,
    ct.POINTER(git_buf),
    ct.POINTER(git_remote))(
    ("git_remote_default_branch", dll), (
    (1, "out"),
    (1, "remote"),))
